		...
		return(
			<Header style={styles.headerStyle}>
                         ...
                         <View style={{padding:10,flexDirection:"row"}}>
                              <Text style={{color:'orange',fontSize:25,fontStyle:"italic",fontWeight:'bold'}}>EZCollection</Text>
                               <Text style={{color:'#17baa1',fontSize:25,fontStyle:"italic",fontWeight:'bold'}}>App</Text>
                        </View>
